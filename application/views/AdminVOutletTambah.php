...
<html>
<head>
	<title> Admin Laundry | Tambah Outlet</title>
...
<?php if ($this->session->has_userdata('username')): ?>
	...
	<div class="row mt-5">
	<div class="container">
		<?= form_open('App_controler/AdminCProsesTambahOutlet', ['method' => 'POST']) ?>
            <div class="form-group">
                <label>Nama Outlet</label>
                <input type="text" class="form-control" name="nm_outlet" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="tlp_outlet" required>
            </div>
