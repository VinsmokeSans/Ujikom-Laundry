...
<html>
<head>
	<title> Owner Laundry | Laporan </title>
...
<?php if ($this->session->has_userdata('username')): ?>
	...
	<div class="row">
		<div class="col-md-12">
			<?php $this->load->view('OwnerHeader') ?>
		</div>
	</div>
   ...
   <?php if (!empty($this->session->flashdata('status'))): ?>
    ...
    <?php endif ?>
     <?= form_open('App_controler/OwnerCCariRange', ['method' => 'POST']) ?>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <a href="<?= site_url('App_controler/Adminpdf') ?>" class="btn btn-outline-success">pdf</a>
                    </div> 
                </div>
            </div>
        </div>
