...
<?php if ($this->session->has_userdata('username')): ?>
	...
	<div class="row mt-5">
	<div class="container">
		<?= form_open('App_controler/AdminCProsesEditPengguna/'.$data['id_user'], ['method' => 'POST']) ?>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="number" class="form-control" name="id_outlet" required value="<?= $data['id_outlet'] ?>">
            </div>
             <div class="form-group">
                <label>Role</label>
                <select class="form-control" name="role" required value="<?= $data['role'] ?>">
                    <option>Admin</option>
                    <option>Kasir</option>
                    <option>Owner</option>
                </select>
